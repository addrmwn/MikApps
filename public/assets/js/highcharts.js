...
(function (U, K) {
        ...
        a = function () {
            ...
            a.prototype.defaultLabelFormatter =
                function (d) {
                    ...
                    "undefined" === typeof J && (J = 1E4 <= Math.abs(a) ? d(a, -1) : d(a,
                        -1, void 0, ""));
                    return J
                };
            ...
            a.prototype.nameToX = function (b) {
                ...
                q(a) || (a = this.options.uniqueNames && c ? d ? c.indexOf(b.name) : r(c.keys[b.name],
            ...
            a.prototype.renderTick = function (b, d, c) {
                var a = this.ticks;
                if (!this.isLinked || b >= this.min && b <= this.max || this.grid && this.grid.isColumn) a[b] || (a[b] = new I(this, b)), c && a[b].isNew && a[b].render(d,
                    !0, -1), a[b].render(d)
            };
            ...
            a = function () {
                ...
                a.prototype.addSeries = function (b, a, c) {
                    ...
                    b && (a = R(a, !0), Q(d, "addSeries", {
                        ...
                        d.isDirtyLegend = !0;
                        d.linkSeries();
                        e.enabledDataSorting && e.setData(b.data,
                            !1);
                        Q(d, "afterAddSeries", {
                            series: e
                        });
    ...
    K(f, "Core/Series/Series.js",
        [f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Point.js"], f["Core/Series/SeriesDefaults.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]],
    ...
    K(f, "Extensions/ScrollablePlotArea.js",
        [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"], f["Core/Series/Series.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]],
        function (a, f, B, H, w, E) {
            var C = a.stop,
                A = E.addEvent,
                u = E.createElement,
        ...
        (function (a) {
            function f(a, b, c, d, f) {
                var h = this,
                    ...
                    x = this.visible && !1 !== a.visible && (a.series.forceDL || k && !u || t || e(c.inside,
                        !!this.options.stacking) && d && g.isInsidePlot(m, l ? d.x + 1 : d.y + d.height - 1, {
                        inverted: l,
                        paneCoordinates: !0,
                        series: h
                    }));
